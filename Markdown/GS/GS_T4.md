...
## 3. Funciones y tareas del profesional de la Seguridad de la Información
...
- Diseño del plan de formación en una entidad
- Asignación de cursos y certificaciones al personal
- Realización de campañas de concienciación y sensibilización, proveer formación en seguridad
...
- Análisis y supervisión de la seguridad de la información en entornos cloud (SaaS, PaaS, IaaS...)
...
- Actividades relacionadas con la seguridad gestionada, el outsourcing, los Centros de Operaciones de Seguridad (SOC)
    - Actividades en las que un tercero el que opera la seguridad de una organización
...
- La seguridad de la información aplicada en entornos críticos para la sociedad (centrales termoeléctricas, hospitales, sector financiero, ...)
    - Regulaciones y requisitos muy concretos

### Seguridad industrial

- Proyectos y tareas relacionados con la aplicación de la seguridad en entornos automáticos e industriales
    - Requisitos y necesidades muy diferentes a los de IT
    - Revisiones de SCADAs y otros sistemas de control industrial (ICS)

### Inteligencia de seguridad

- Aplicación de técnicas de inteligencia artificial a la detección de amenazas
    - Técnicas de correlación de eventos y big data
    - Recolección de eventos para correlar (SIEMs)

### Protección de las comunicaciones

- Tareas relacionadas con la mitigación de riesgos en las comunicaciones
    - Análisis de redes
    - Supervisión y configuración de cortafuegos, VPNs, IDSs, IPSs, balanceadores, ...
...
- Certificaciones principales:
    ...
    - (CSSLP) ertified Secure Software Lifecycle Professional
